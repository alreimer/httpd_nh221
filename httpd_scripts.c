...
void find_mntfolder(FILE *out)	/*is it in share.htm->find.htm? which isn't exist!*/
{
	...
	else
	{
	 ...
	 #if defined(LOBOS) || defined(CENTURY)
	     fprintf(out,"</table><br><table border=\"0\" width=\"30%%\" align=\"center\"><tr><table><tr><td width=\"23%%\"></td><td width=\"30%%\"><input type=button value=\"��\" onClick=\"history.back()\"></td></tr></table><table><tr><td>&nbsp;</td></tr></table></tr></table></form></body></html>\n<script language=\"JavaScript\">var num=0;function box_change(){if (arguments[0] == true){num++;}else if (arguments[0] == false) {num--;}if (num==0) {document.form1.del.disabled=true;}else {document.form1.del.disabled=false;}}</script>");
	#else
...
char LineBuf[READ_SHORT];
    ...
    case 5:
	    ...
	    fprintf(out, "</b></font><br><br>Please try again...<br></td></tr><tr><td width=100%% align=\"right\"><input type=button value=\"��\" onClick=\"%s\"></td></tr></table>\n", "location.replace('/FTP.htm')" );
    #else
...
//	fprintf(out,"<table border=\"0\" width=\"70%%\" align=\"center\"><tr><td><br><b>Firmware Upgrade Error... <br><br>\nerror message: <font color=ff0000>%s</font><br>", message_string );
	...
	void Goto_page(FILE *out, char *url, char *type, char *folder_name){
	    ...
	    if(!strcmp( type, "User"))
#ifdef CENTURY
		fprintf(out,"<table border=\"0\" width=\"550\" align=\"center\"><tr><td><br><b>����X��ܵ�B <br><br>��?[U[ <font color=\"#0000ff\"><b>\"%s\"</b></font>\n", folder_name);
#else
			fprintf(out,"<table border=\"0\" width=\"85%%\" align=\"center\"><tr><td><br><b>����X��ܵ�B <br><br>��?[U[ <font color=\"#0000ff\"><b>\"%s\"</b></font>\n", folder_name);
#endif
		else
#ifdef CENTURY
	    fprintf(out,"<table border=\"0\" width=\"550\" align=\"center\"><tr><td><br><b>����X��ܵ�B <br><br>��?[U[ <font color=\"#0000ff\"><b>\"%s\"</b></font>\n", folder_name);
#else
			fprintf(out,"<table border=\"0\" width=\"70%%\" align=\"center\"><tr><td><br><b>����X��ܵ�B <br><br>��?[U[ <font color=\"#0000ff\"><b>\"%s\"</b></font>\n", folder_name);
#endif

			fprintf(out,"�ANZX����X���?�Au�Lv���<a href=\"%s\">tH?_[</a>�N?bN�ĭ���B<br></body></html>\n",url);
	...
	fprintf(out,"<P><FONT class=style9>VXe?��</FONT></P>\n");
	...
	fprintf(out,"<td width=\"100%\" bgcolor=\"#FFFFFF\">\n<font size=3>����X��ܵ�B</font><br><br>\n");
	fprintf(out,"		��?[U[ <font color=\"#0000ff\"><b>\"%s\"</b></font> �ANZX����X���?�A<a href=\"%s\" target=_self><font color=\"#FF2222\">��</font></a> �N?bN�ĭ���B<br>\n",folder_name,url);
